...
import ti.umy.webservice.webservice.c.project.satu.exceptions.NonexistentEntityException;
import ti.umy.webservice.webservice.c.project.satu.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy.webservice_webservice.c.project.satu_jar_0.0.1-SNAPSHOTPU");
